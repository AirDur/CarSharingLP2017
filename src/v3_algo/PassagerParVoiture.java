...
public class PassagerParVoiture {
	...
	*/
	...
	/**
	 * tableau de nombre de passager r�el/voiture
	 */
  ...
  | |___| (_) | | | \__ \ |_| |  | |_| | (__| ||  __/ |_| | |   
   \_____\___/|_| |_|___/\__|_|   \__,_|\___|\__\___|\__,_|_|  
	...
	/**
	 * On cr�er des tableau de Passager de de Possitionpassager
	 */
   ...
   */
    ...
    /**
     * Retourne une liste de passager g�n�r� al�atoirement, en fonction des passagers et du nombre de place. <br>
     ...
     * S'il y a autant ou moins de place que de passager, on se retrouve avec une liste sans �l�ment vide : P3 P4 p7 P10 P8 P2 P1 P9 P5 P6
     * @return
     * @version Build III -  v0.5
   ...
   private void Algo_DeterministeParRecursivite(Passager[] passagers, Cell[] listeDesPoints, boolean[] possable, boolean[] selected, int n, int numeroVoiture) {
   	...
   	if(n==((this.nbPassagerParVoiture[numeroVoiture]*2)-1)) { 
  		...
  		//Pour chaque passager, on lit s'il est d�j� s�lectionn�. Si c'est non, on cr�e une branche, si oui, on saute.
  		// On lit aussi si le passager est possable. Si oui, on cr�e une branche, sinon, on saute.
  		for(int i=0;i<passagers.length;i++) {
